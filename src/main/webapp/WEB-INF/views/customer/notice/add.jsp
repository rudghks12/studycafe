...
<style>
  ...
  /*  width: 1100px;*/
  /*}*/
  /* Adjust the CKEditor container and content */
  .ck.ck-editor {
  ...
  .page-content { /* Create a new CSS class for the content section */
    width: 80%;
    margin: 0 auto;
  }
  ...
  <div>
    <div style="position: relative; ">
      ...
      <div style="display: inline-block; vertical-align: middle; margin: 20px; ">
        ...
        <p style="color: #9D6529; font-size: 2.17em; font-weight: bold;  margin-left: 10px; display: inline;">관리자 공지사항 글쓰기</p>
      </div>


    <form action="${path}/customer/notice/add" method="post">
      <security:csrfInput/>
      ...
      <div class="form-group">
        ...
        <select id="kind" name="kind" required>
          <option value="교육콘텐츠">교육콘텐츠</option>
          <option value="필독공지">필독공지</option>
