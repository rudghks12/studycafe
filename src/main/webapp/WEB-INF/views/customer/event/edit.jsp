  ...
  <div>
    <div style="position: relative;">
      ...
      <div style="display: inline-block; vertical-align: middle; margin: 20px;">
        ...
        <p style="color: #9D6529; font-size: 2.17em; font-weight: bold;  margin-left: 10px; display: inline;">이벤트 수정</p>
      </div>

    <form action="${path}/customer/event/edit/${event.no}" method="post"> <!-- 수정 컨트롤러의 URL로 변경 -->
      <security:csrfInput/>
      ...
      <div class="form-group">
        <label for="editor">내용:</label>
          <textarea name="content" class="editor" id="editor" style="height: 800px;">${event.content}</textarea>
      </div>
      <br>
      <div class="form-group">
        <button type="submit" onclick="return confirm('정말로 수정하시겠습니까?')" class="edit-button">수정하기</button>
        <a href="${path}/customer/event/detail/${event.no}" class="back-button">이전으로</a>
      </div>
