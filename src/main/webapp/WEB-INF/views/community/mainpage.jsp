...
<section class="content-container">
    ...
    <div class="board-search">
        <h2 style="font-size: 1.5em; font-weight: bold;">소통을 통해 능률을 향상시켜보세요.</h2>
        <p>혼자 공부하기 힘들고 지칠때, 다같이 해결해봐요.</p>
        ...
        <div class="search"  style="display: inline-block; vertical-align: middle;  position: relative; margin-bottom: 20px; margin-right: 100px;">
            ...
            <input type="text" name="keyword" id="search-keyword-large" class="search-keyword-large" placeholder="알고 싶은 모든 커뮤니티 정보를 검색해보세요" style="width: 400px;">
        </div>

        <div class="community-move">
            <a href="${ path }/community/listpage?kind=자유게시판"  class="">
                <div>
            ...
            <a href="${ path }/community/listpage?kind=스터디모집"  >
                <div>
            ...
            <a href="${ path }/community/listpage?kind=공부법공유"  >
                <div>
            ...
            <a href="${ path }/community/listpage?kind=합격후기"  >
                <div>
...
<script>
    ...
    function changeSortingOption() {
        ...
        window.location.href = "${path}/community/mainpage?sortingOption=" + sortingOption;
    }

    const handle_pagination = (page, sortingOption) => {
        console.log(page, sortingOption);

        let path = '/studycafe/community/mainpage?';
